...
/*#################################################################################*/
  ...
  qd = '"'
  qs = "'"      /*  PSTOPNGLN2V_130704_net.bmon */
  infile  = p1  /* infile:  PSTOPNGLN2V_130704_net.bmon */
                /* outfile: HOSTNAMEXXX_yymmdd_netios.bmon */
  vcnt_max = 0
  ...
  parse var infile xx '_net.bmon'
  outfile = xx'_netios.bmon'
